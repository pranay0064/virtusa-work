			...
			<div class="modal-body mx-3">
				<form action="updateUser.do" method="post">
					...
					<label for="userName">UserName</label> <input type="text" id="userName"
						name="userName" value="${user.getUserName()}"> <input
						type="hidden" name="userId" value="${user.getId()}"> <label
						for="mobileNumber">MobileNumber</label> <input type="text"
						id="mobileNumber" name="mobileNumber"
						value="${user.getMobileNumber()}"> <label for="email">Email</label>
					<input type="email" id="email" name="email"
						value="${user.getEmail()}"> <label for="password">Password</label>
